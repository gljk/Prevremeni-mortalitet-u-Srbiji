...
moran.test(unname(unlist(c(x[,variable]))),lw)
...
ggsave(built_map,filename =  paste0(deparse(substitute(standardized_YPLL_Avoidable)),".png"), units = "mm", width = 175, dpi = 600)
knitr::plot_crop(x = paste0(deparse(substitute(standardized_YPLL_Avoidable)),".png"))
...
aviod_stypll_map<- buildMap(map=Serbia,foritfied_map = SRMAP,motality_dataframe = standardized_YPLL_Avoidable, variable = "YPLLi",paleta="Reds")
#Amenable  standardized YPLL map
aviod_stypll_map<- buildMap(map=Serbia,foritfied_map = SRMAP,motality_dataframe = standardized_YPLL_Amenable, variable = "YPLLi",paleta="Purples")
#Preventable standardized YPLL map
aviod_stypll_map<- buildMap(map=Serbia,foritfied_map = SRMAP,motality_dataframe = standardized_YPLL_Preventable, variable = "YPLLi",paleta="Greens")
